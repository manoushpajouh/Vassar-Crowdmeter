...
import com.example.vassarcrowdmeterapp.databinding.ActivityMainBinding;

public class MainView implements IMainView{

    FragmentManager fmanager; // lets us perform fragment transactions
    // gives us access to all the graphical components in res/layout/main.xml
